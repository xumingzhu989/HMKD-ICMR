...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='camvid',
                        help='dataset name')
    parser.add_argument('--data', type=str, default='./data/Camvid/',
    ...
    parser.add_argument('--teacher-pretrained-base', type=str, 
                        default='G12_deeplabv3_resnet101_camvid_OM((OM-resnet101-0.01))_best_model.pth',help='pretrained backbone')
    parser.add_argument('--teacher-pretrained', type=str,
                        default='G12_deeplabv3_resnet101_camvid_OM((OM-resnet101-0.01))_best_model.pth',
                        help='pretrained seg model')
    parser.add_argument('--student-pretrained-base', type=str, default='G12_segformer_MiT_B0_camvid_OM((OM-camvid-0.0007-b0-adam))_best_model.pth',
                        help='pretrained backbone')
    # CIRKD1/CIRKD1127/saves/models/G12_deeplabv3_resnet18_citys_OM(None).pth
    parser.add_argument('--student-pretrained', type=str, default='G12_segformer_MiT_B0_camvid_OM((OM-camvid-0.0007-b0-adam))_best_model.pth',
                        help='pretrained seg model')
...
class Trainer(object):
    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            gla_loss=self.gla_model(t_outputs[1],s_outputs[2][-2]) # 1
            hfa_loss=self.hfa_model(t_outputs[3],(sum(s_outputs[4])-s_outputs[4][0])/(len(s_outputs[4])-1))
            ...
            # #取一些特征图
            losses = task_loss + GLA_loss + HFA_loss 
            ...
            if iteration % log_per_iters == 0 and save_to_disk:
                logger.info(
                    "Iters: {:d}/{:d} || Lr: {:.6f} || Task Loss(resnet101-mitb0-0.002-SGD): {:.4f} || GLA Loss: {:.4f} || HSAM Loss: {:.4f} "\
...
def save_checkpoint(model, args, is_best=False):
    ...
    filename = 'G12_{}_{}_{}_OM(resnet101-mitb0-0.002-SGD).pth'.format(args.student_model, args.student_backbone, args.dataset) ###
    ...
    if is_best:
        best_filename = 'G12_{}_{}_{}_OM(resnet101-mitb0-0.002-SGD)_best_model.pth'.format(args.student_model, args.student_backbone,
                                                                        args.dataset)###
...
if __name__ == '__main__':
    ...
    logger = setup_logger("semantic_segmentation", args.log_dir, get_rank(),
                              filename='{}_G12_{}_{}_{}_OM(resnet101-mitb0-0.002-SGD)_log.txt'.format(
